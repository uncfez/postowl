...
<NotEditable {editable}>
  <div class="bg-white font-medium">
    <div class="max-w-screen-md mx-auto px-6 py-5 flex space-x-8 text-sm">
      ...
      <a href="/imprint">Vad är Turf?</a>
      <a class="underline font-medium" href="https://turfgame.com/" target="_blank">turfgame.com</a>
      {#if count}
        <div class="flex-1" />
        <div class="text-xs font-normal flex items-center space-x-2">
          ...
          <div class="text-center">
            Drivs med <a class="underline font-medium" href="https://www.postowl.com">PostOwl</a>.
          </div>
        </div>
      {/if}
    </div>
