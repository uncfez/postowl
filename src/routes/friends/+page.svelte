...
<div class="max-w-screen-md mx-auto px-6 pb-8">
  <h1 class="text-center font-bold text-2xl sm:text-4xl pt-14">{data.friends.length} Vänner</h1>
  <p class="text-center sm:text-xl pb-4">Börja skriva så auto-kompletteras befintliga namn när inlägg ska delas.</p>
  <div class="flex justify-center pb-14">
    <PrimaryButton size="sm" href="/friends/new">Lägg till vän</PrimaryButton>
  </div>
  <div class="space-y-4">
